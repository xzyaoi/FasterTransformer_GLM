...
#include "src/fastertransformer/layers/attention_layers/TensorParallelGlmContextAttentionLayer.h"
...
{
    self_attention_layer_ = new TensorParallelGlmContextAttentionLayer<T>(max_batch_size_,
                                                                          max_seq_len_,
                                                                          head_num_,
                                                                          size_per_head_,
...
void GlmContextDecoder<T>::forward(std::vector<Tensor>* output_tensors,
                                    ...
                                    const LayerNormWeight<T>* final_layernorm_weight)
{
    ...
    forward(&output_tensors_map, &input_tensors_map, glm_decoder_layer_weight, final_layernorm_weight);
}

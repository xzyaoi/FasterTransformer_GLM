...
#include "src/fastertransformer/layers/attention_layers/TensorParallelGlmDecoderSelfAttentionLayer.h"
...
{
    self_attention_layer_ = new TensorParallelGlmDecoderSelfAttentionLayer<T>(max_batch_size_,
                                                                           head_num_,
                                                                           size_per_head_,
...
void GlmDecoder<T>::forward(std::vector<Tensor>* output_tensors,
                             ...
                             const std::vector<GlmDecoderLayerWeight<T>*>* glm_decoder_layer_weight)
{
    ...
    forward(&output_tensors_map, &input_tensors_map, glm_decoder_layer_weight);
}
template<typename T>
                             ...
                             const std::vector<GlmDecoderLayerWeight<T>*>* glm_decoder_layer_weight)
{
    ...
    for (uint l = 0; l < num_layer_; l++) {
        ...
        // layer_input = layernorm_1(layer_input)
        // attn_output = attn(layer_input)
        // attn_output = layer_input * alpha + attn_output
        // attn_output = layernorm_2(attn_output)
        // ffn_output = geglu_ffn(attn_output)
        // layer_output = attn_output * alpha + ffn_output

        invokeGeneralLayerNorm(decoder_normed_input_,
                                layer_input,
                                glm_decoder_layer_weight->at(l)->self_attn_layernorm_weights.gamma,
                                glm_decoder_layer_weight->at(l)->self_attn_layernorm_weights.beta,
                                local_batch_size,
                                hidden_units_,
                                stream_,
                                1e-5f);
        ...
        self_attention_layer_->forward(&self_attention_output_tensors,
                                       ...
                                       &glm_decoder_layer_weight->at(l)->self_attention_weights);
        ...
        invokeAlphaAddBiasResidualLayerNorm(
            self_attn_output_,
            decoder_normed_input_,
            glm_decoder_layer_weight->at(l)->self_attention_weights.attention_output_weight.bias,
            glm_decoder_layer_weight->at(l)->glu_ffn_layernorm_weights.gamma,
            glm_decoder_layer_weight->at(l)->glu_ffn_layernorm_weights.beta,
            T(sqrt(2 * num_layer_)),
            local_batch_size,
            hidden_units_,
            stream_);
        ...
        glu_ffn_layer_->forward(&ffn_output_tensors, &ffn_input_tensors, &glm_decoder_layer_weight->at(l)->glu_ffn_weights);
        ...
        invokeAlphaAddBiasResidual(
            layer_output,
            self_attn_output_,
            glm_decoder_layer_weight->at(l)->glu_ffn_weights.output_weight.bias,
            T(sqrt(2 * num_layer_)),
            local_batch_size,
            hidden_units_,
            stream_);

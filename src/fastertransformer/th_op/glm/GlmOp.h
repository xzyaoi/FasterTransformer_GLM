...
public:
        ...
        int8_scales_(int8_scales)
    {
        ...
        for (int i = 0; i < (int)layer_num_; i++) {
            ...
            glm_weights_.decoder_layer_weights[i]->self_attention_weights.query_weight.scale =
                get_ptr<float>(int8_scales_[i + 0 * layer_num_]);
            glm_weights_.decoder_layer_weights[i]->self_attention_weights.attention_output_weight.scale =
                get_ptr<float>(int8_scales_[i + 1 * layer_num_]);
            glm_weights_.decoder_layer_weights[i]->glu_ffn_weights.intermediate_weight[0].scale =
                get_ptr<float>(int8_scales_[i + 2 * layer_num_]);
            glm_weights_.decoder_layer_weights[i]->glu_ffn_weights.intermediate_weight[1].scale =
                get_ptr<float>(int8_scales_[i + 3 * layer_num_]);
            glm_weights_.decoder_layer_weights[i]->glu_ffn_weights.output_weight.scale =
                get_ptr<float>(int8_scales_[i + 4 * layer_num_]);
        }
...
private:
    ...
    ft::cublasMMWrapper* cublas_wrapper = nullptr;
    ft::Allocator<ft::AllocatorType::TH>* allocator = nullptr;
...
private:
    ...
    std::vector<th::Tensor> int8_scales;
};

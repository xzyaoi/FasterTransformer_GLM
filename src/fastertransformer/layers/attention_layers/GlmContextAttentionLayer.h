...
template<typename T>
class GlmContextAttentionLayer: public BaseAttentionLayer<T> {
private:
    // buffer handling
...
public:
    ...
    GlmContextAttentionLayer(GlmContextAttentionLayer<T> const& attention_layer);

    virtual ~GlmContextAttentionLayer();
